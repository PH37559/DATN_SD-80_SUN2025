...
public interface GioHangChiTietService {
    ...
    void clearByIdCartAndIdBook(Integer idGioHang, Integer idSach);

    GioHangChiTiet getByIdCartAndIdBook(Integer idGioHang, Integer idSach);

    void store(GioHangChiTietDTO gioHangChiTiet);

    void deleteAll(List<GioHangChiTiet> gioHangChiTietList);

    int countItemsInCart(Integer idGioHang);
}
